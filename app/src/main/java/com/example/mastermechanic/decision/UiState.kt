 ...
 *
 * 声明顺序 = 多状态同时命中时的候选优先级：活动弹窗 / 新手大厅 / 新手引导为 FR-01、FR-02
...
enum class UiState(val label: String, val defaultSignalName: String) {
    ...
    /** 新手大厅（§2.1）：新手大厅标志；FR-02 次高优先级。 */
    TUTORIAL_HALL("新手大厅", "tutorial_hall"),

    /** 新手引导（§2.1）：新手引导标志；FR-02 次高优先级。 */
    TUTORIAL_GUIDE("新手引导", "tutorial_guide"),
